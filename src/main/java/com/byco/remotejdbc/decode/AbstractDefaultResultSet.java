...
/**
 * @Classname SimpleResultSet
 * @Description TODO
 * @Date 2022/7/8 15:58
 * @Created by byco
 */
public abstract class AbstractDefaultResultSet implements java.sql.ResultSet {
    /**
    ...
    @Override
    public abstract Date getDate(int columnIndex, Calendar cal) throws SQLException;
    ...
    @Override
    public abstract Date getDate(String columnLabel, Calendar cal) throws SQLException;
    ...
    @Override
    public abstract Time getTime(int columnIndex, Calendar cal) throws SQLException;
    ...
    @Override
    public abstract Time getTime(String columnLabel, Calendar cal) throws SQLException;
    ...
    @Override
    public abstract Timestamp getTimestamp(String columnLabel, Calendar cal) throws SQLException;
    ...
    @Override
    public abstract <T> T getObject(String columnLabel, Class<T> type) throws SQLException;
