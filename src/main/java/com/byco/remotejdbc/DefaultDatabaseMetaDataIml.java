...
/**
 * @Classname DefaultDatabaseMetaDataIml
 * @Description TODO
 * @Date 2022/7/21 9:55
 * @Created by byco
 */
public class DefaultDatabaseMetaDataIml implements java.sql.DatabaseMetaData{

    private final String url;

    public DefaultDatabaseMetaDataIml(String url) {
        this.url = url;
    }
