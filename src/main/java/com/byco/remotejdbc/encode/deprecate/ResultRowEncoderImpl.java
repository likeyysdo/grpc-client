 ...
 * @Created by byco
 */
public class ResultRowEncoderImpl implements ResultRowEncoder123 {
    ...
    private ResultRowEncoderImpl(){

    }



    public static ResultRowEncoderImpl getInstance(int initialSize){
        ResultRowEncoderImpl encoder = new ResultRowEncoderImpl();
        encoder.encoder = CodedOutputStream.newInstance(new FastByteArrayOutputStream(initialSize));
        return encoder;
    }

    public static ResultRowEncoderImpl getInstance(){
        ResultRowEncoderImpl encoder = new ResultRowEncoderImpl();
        encoder.encoder = CodedOutputStream.newInstance(new FastByteArrayOutputStream());
        return encoder;
    }
